...
district_string = "東區、中區、中西區、南區、北區、安平區、安南區、新營區、永康區、鹽水區、白河區、麻豆區、佳里區、新化區、善化區、學甲區、柳營區、後壁區、東山區、下營區、六甲區、官田區、大內區、西港區、七股區、將軍區、北門區、新市區、安定區、山上區、玉井區、楠西區、南化區、左鎮區、仁德區、歸仁區、關廟區、龍崎區"
